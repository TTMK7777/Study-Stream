...
import type { Subject, Topic } from "@/content/shindanshi";
                  ...
                  {subject.topics.map((topic) => (
                    <li key={topic.id}>
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-3 border-b border-zinc-900/50 px-6 py-2.5 text-left text-sm transition-colors last:border-b-0 hover:bg-zinc-900"
                      >
